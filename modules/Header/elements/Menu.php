...
class Menu extends Block
{
    ...
    public function render($settings = [])
    {
        ...
        return "<nav class='flex items-center whitespace-nowrap overflow-hidden menu-nav' 
                 ...
                 style='color: {$color}; font-size: {$size}px; gap: {$gap}px; text-transform: {$transform}; font-weight: {$weight};'>
                {$html}
            </nav>";
    }
        ...
        return '
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="range" data-style="gap" min="10" max="60" value="20" class="prop-input w-full accent-indigo-500">
                </div>
            </div>
        ';
    }
