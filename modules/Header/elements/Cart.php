...
class Cart extends Block
{
    ...
    public function render($settings = [])
    {
        ...
        return "
            <a href='{$customLink}' class='flex items-center cursor-pointer group relative px-2 hover:opacity-80 transition' style='text-decoration: none; color: {$color}; white-space: nowrap;'>
                <div class='relative flex items-center'>
                    <i class='ph {$iconType}' style='font-size: {$size}px; line-height: 1;'></i>
        ...
        return '
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div><label class="text-xs text-gray-400 block mb-1">Size Icon (px)</label><input type="number" data-style="font-size" value="24" class="prop-input w-full bg-gray-800 text-white p-2 rounded border border-gray-700 text-xs"></div>
                </div>
