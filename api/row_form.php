...
<div class="px-4 pb-20 space-y-6">
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <div class="text-[10px] text-gray-500 mt-1">Áp dụng cho text/icon con</div>
        </div>
    </div>
    ...
    <div class="space-y-4">
        ...
        <div>
            <label class="text-xs text-gray-400 block mb-1">Kiểu bao (Container)</label>
            <select data-style="width-mode"
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <input type="range" data-style="container-width" min="1000" max="1920" step="10" value="1200"
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <input type="range" data-style="min-height" min="40" max="200" value="50"
                    class="prop-input flex-1 accent-indigo-500"
                    oninput="this.nextElementSibling.innerText = this.value + 'px'">
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center justify-between bg-gray-800 p-2 rounded border border-gray-700">
            ...
            <input type="checkbox" data-style="sticky"
                class="prop-input w-4 h-4 rounded bg-gray-700 border-gray-600 accent-indigo-500 cursor-pointer">
        </div>
        <div>
            ...
            <select data-style="box-shadow"
                ...
                <option value="0 20px 25px -5px rgb(0 0 0 / 0.1)">Rất Đậm (Extra)</option>
            </select>
        </div>
    </div>
